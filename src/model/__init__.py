...
from .partonomic_table import PartonomicTable
from .partonomic import Partonomic
from .cub_part import PartonomicCUB
...
def get_model(name):
    return {
        'partonomic': Partonomic,
        'partonomic_table': PartonomicTable,
        'Partonomic_CUB': PartonomicCUB
    }[name]
