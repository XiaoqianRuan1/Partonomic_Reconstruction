...
from .attention import TextureTransformer, DETR, Transformer
from .weights import ProgressiveWeightsField
from .encoder import Encoder, AttEncoder
...
class Partonomic(nn.Module):
    ...
    def _init_encoder(self, img_size, **kwargs):
        ...
        """
        self.shared_encoder = kwargs.get('shared', {})
