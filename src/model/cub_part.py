...
class PartonomicCUB(nn.Module):
    ...
    def _init_shapes(self,**kwargs):
        ...
        self.weights_field = ProgressiveWeightsField(out_ch=N_K, inp_dim=self.n_features, name='weights',**weights_kwargs)
    ...
    def quantitative_eval(self, loader, device, evaluator=None):
        self.eval()
        if loader.dataset.name in ['cub_images']:
