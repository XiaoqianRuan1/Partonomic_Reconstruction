...
class Unicorn(nn.Module):
    ...
    def _init_meshes(self, **kwargs):
        ...
        self.deform_field5 = ProgressiveField(inp_dim=self.tx_features, name='deform5', **deform_kwargs)
        self.deform_field6 = ProgressiveField(inp_dim=self.tx_features, name='deform6', **deform_kwargs)
    ...
    def predict_disp_verts(self,verts,local_features,features_seg):
        ...
        disp_verts.append(self.deform_field5(verts,features[:,4,:]))
        disp_verts.append(self.deform_field6(verts,features[:,5,:]))
    ...
    def get_prototype(self):
        ...
        disp_verts.append(self.deform_field5(verts,latent[:,4,:]))
        disp_verts.append(self.deform_field6(verts,latent[:,5,:]))
        disp_verts = torch.stack(disp_verts,1) # BKV3
