...
class Unicorn(nn.Module):
    ...
    def __init__(self, img_size, **kwargs):
        ...
        self.renderer = Renderer(img_size, True, False, **kwargs.get('renderer', {}))
    ...
    def _init_meshes(self, **kwargs):
        ...
        weights_kwargs = kwargs.pop('weights_fields',{})
    ...
    def _init_loss(self, **kwargs):
        ...
        loss_weights = {
            ...
            'masks': kwargs.pop('mask_weight',1.0),
            'parts': kwargs.pop('part_weight',1.0),
    ...
    def forward(self, inp, debug=False):
        ...
        masks, parts = inp["masks"], inp["parts"]
    ...
    def compute_losses(self, meshes, alpha, masks, rec, imgs, rec_part, parts, R, T, average_txt=False):
        ...
        if 'masks' in losses:
            losses['masks'] = self.loss_weights['masks'] * self.mask_loss(alpha, masks)
    ...
    def qualitative_eval(self, loader, device, path=None, N=32):
        ...
        for j, (inp, _) in enumerate(loader):
            ...
            for k in range(B):
                ...
                save_mesh_as_gif(mcenter, path / f'{i}_meshabs.gif', n_views=NV, dist=d, elev=e, renderer=self.renderer)
                ...
                save_mesh_as_gif(mcenter_part, path / f'{i}_meshuv_weights.gif', dist=d, elev=e, renderer=self.renderer)
